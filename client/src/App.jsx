...
// const ForgotPassword = lazy(() => import("./auth/ForgotPassword.jsx")); // New: ForgotPassword page
// const SignUp = lazy(() => import("./auth/SignUp.jsx")); // New: Signup page
/**
...
function AppContent() {
  ...
  const pathsToHideLayout = ["/signin", "/forgot-password", "/signup"];
