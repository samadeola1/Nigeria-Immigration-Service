  ...
  return (
    <div className='border-2 border-[#E9E9E9] bg-white rounded-xl flex flex-col items-center gap-[33px] p-[22px] '>
      ...
      <div className='flex flex-col gap-[11px]'>
        ...
        <button className='bg-[#00AA55]  hover:bg-green-700 transition-colors duration-200 px-[33px] py-[9px] rounded-md font-semibold text-[16px] cursor-pointer text-white'>{content.click}</button>
    </div>
  )
}
