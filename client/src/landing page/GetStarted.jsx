...
const GetStarted = () => {
  return (
    <div className="w-full bg-white">
      <main>
        <section className="py-16 px-4 text-center  md:hidden  container mx-auto overflow-hidden font-poppins">
          <h2 className="text-[28px] md:text-[44px] font-poppins font-bold mb-4 text-[#212121]">
            Get Started
          </h2>
