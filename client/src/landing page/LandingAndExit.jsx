...
const LandingAndExit = () => {
  return (
    <div className="w-full bg-[#E6F7EE] border-0">
      <div className="mx-auto w-11/12 container px-4 sm:px-6 lg:px-8 ">
        <div className="flex lg:flex-row  items-center gap-0 md:gap-[60px] lg:gap-[80px] py-[80px] flex-col-reverse  md:flex-col">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-[#555555] text-[20px] leading-relaxed mb-6 font-normal font-poppins hidden lg:block lg:pr-[100px]">
