      ...
      <div className="lg:hidden container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div className="flex justify-center w-full">
          <img
            src={cerpacImgMobile}
            alt="CERPAC"
            className="max-w-[350px] w-full h-auto rounded-[24px] shadow-md"
          />
        </div>
        <div className="flex justify-center w-full"></div>
      </div>
      {/* Desktop Layout */}
      <div className="hidden lg:flex container mx-auto  py-8 flex-row items-center lg:px-[100px] gap-[85px]">
        {/* Image Section */}
        ...
        <div className="flex flex-col justify-center items-start text-left">
          ...
          <h2 className="text-[20px] whitespace-nowrap text-[#474747] mb-4 font-semibold font-600">
            Combined Expatriate Residence Permit and Aliens Card
          </h2>
          ...
          <button className="group flex items-center text-[#006834] font-semibold text-[18px] focus:outline-none">
            Read more
            <img
              src={arrowRight}
              alt="arrow right"
